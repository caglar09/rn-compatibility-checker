 ...
 */
function checkCompatibility(packageJsonPath, options) {
  try {
    // Set platforms
    ...
    console.log(`\nPerforming compatibility check for ${chalk.bold(packageData.name)} project...\n`);
    ...
    console.log(`Found ${Object.keys(dependencies).length} React Native dependencies.\n`);
